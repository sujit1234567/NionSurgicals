...
<input type="hidden" name="action" value="update">
 ...
 <table>
   ...
   <td><input type="text" name="pname" value=<%=p.getProductname() %>></td>
   </tr>
   <tr>
   <td>Insert Product Image:</td>
   <td><input type="text" name="pimage" value=<%=p.getProductimage() %>></td>
   </tr>
   <tr>
   <td>Enter Product category:</td>
   <td><input type="text" name="pcategory" value=<%=p.getProductcategory() %>></td>
   </tr>
   
   <tr>
   <td>Enter Product Description:</td>
   <td><input type="text" name="pdescription" value=<%=p.getProductdescription() %>></td>
   </tr>
   <tr>
   <td>Enter Product Price:</td>
   <td><input type="text" name="pprice" value=<%=p.getProductprice() %>></td>
   </tr>
   <tr>
